...
<div class="">
    ...
    <div class="page-utilities mb-3">
        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
          {{--   <div class="col-auto">
            ...
            <div class="col-auto">
                <input type="text" id="search-docs" name="searchdocs" class="form-control search-docs" wire:model.debounce.100ms="search" placeholder="Search Store">
            </div>
            <div class="col-auto">
                <div class="col-auto">
    ...
    <div class="page-utilities secondary-bg p-3 mb-2">
        <div class="row g-2 justify-content-start justify-content-md-start align-items-center">
            ...
            <div class="col-auto d-flex flex-column">
                <label for="store" class="form-label">Sub Category</label>
                <select class="form-select form-select-sm ms-auto d-inline-flex w-auto" wire:model="subCategory">
            ...
            <div class="col-auto d-flex flex-column">
                <label for="store" class="form-label">Sub Sub Category</label>
                <select class="form-select form-select-sm ms-auto d-inline-flex w-auto" wire:model="subSubCategory">
                    <option value hidden selected>--Select Sub Sub Category--</option>
                    <option value="">All</option>
                    @forelse ($subSubCategoryList as $item)
                        <option value="{{ $item->id }}">{{ $item->name }}</option>
                    @empty
                    @endforelse
                </select>
   ...
   {{--  <div class="accordion" id="accordionFilter" >
    ...
    <div class="row mb-3">
        <h5 class="fw-bold text-end ">Total: {{$total}}</h5>
    </div>
    {{-- Pagination --}}
    <div class="row">
