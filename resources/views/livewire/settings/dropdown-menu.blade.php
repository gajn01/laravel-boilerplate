@section('title', 'Mary Grace Restaurant Operation System / Dropdown Menu Settings')

<div class="container-xl">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item "><a href="{{ route('dropdown') }}">Dropdown</a></li>
            <li class="breadcrumb-item active">{{ $dropdown_name }}</li>
    ...
    <div class="page-utilities mb-3">
        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
            ...
            <div class="col-auto">
                <div class="col-auto">
                    <a class="btn cta-bg" data-bs-toggle="modal" data-bs-target="#dropdown_menu_modal"
        ...
        <div class="app-card-body">
            <div class="table-responsive">
                <table class="table app-table-hover mb-0 text-left">
                    ...
                    <tbody>
                        @forelse ($dropdown_menu_list as $dropdown)
                            <tr>
                                ...
                                <td class="cell table-action-sm">
                                    ...
                                    <a href="#"
                                        wire:click="onAlert(true,'Confirm','Are you sure you want to delete this dropdown menu?','Successfully deleted','warning',{{ $dropdown['id'] }})">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            <nav class="app-pagination">
                {{ $dropdown_menu_list->onEachSide(0)->links() }}
            </nav>
            <!--//app-pagination-->
    ...
    <div wire:ignore.self class="modal fade" id="dropdown_menu_modal" tabindex="-1" data-bs-backdrop="static"
