                        ...
                        @if ($sub_category_list)
                            @foreach ($sub_category_list as $sub_category)
                                <tr>
                                    ...
                                    <td class="cell">
                                        <a
                                            href="{{ route('sub-category-label', [$category_id, $sub_category['id']]) }}">
                                        ...
                                        <a href="#"
                                            wire:click="onAlert(true,'Confirm','Are you sure you want to delete this Sub Category record?','warning',{{ $sub_category['id'] }})">
                                            <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512">
                                                <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                <path
