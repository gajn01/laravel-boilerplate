...
<div class="container-xl">
    ...
    <div class="page-utilities mb-3">
        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
            ...
            <div class="col-auto">
                <div class="col-auto">
                    <a class="btn app-btn-primary" data-bs-toggle="modal" data-bs-target="#label_modal"
                        ...
                        @if ($label_list)
                            @foreach ($label_list as $label)
                                <tr>
                                    ...
                                    <td class="cell">
                                        @if ($is_sub == 1)
                                            <a  href="{{ route('sub-sub-category-label', [$category_id, $sub_category_id, $label['id']]) }}"><svg class="icon"
                                        ...
                                        <a href="" wire:click="showModal({{ $label['id'] }})"
                                            data-bs-toggle="modal" data-bs-target="#label_modal">
                                        ...
                                        <a href="#"
                                        wire:click="onAlert(true,'Confirm','Are you sure you want to delete this label record?','warning',{{ $label['id'] }})">
                                        <svg class="icon" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 448 512">
                                            <!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                            <path
    ...
    <div wire:ignore.self class="modal fade" id="label_modal" tabindex="-1" data-bs-backdrop="static"
