@section('title', 'Mary Grace Restaurant Operation System / Critical Deviation')

<div class="container-xl">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active">Critical Deviation</li>
        </ol>
    </nav>
                        ...
                        {{-- @forelse ($dropdown_list as $dropdown)
                            <tr>
                                ...
                                <td class="cell table-action-sm">
                                    ...
                                    <a href="#"
                                        wire:click="onAlert(true,'Confirm','Are you sure you want to delete this dropdown?','warning',{{ $dropdown['id'] }})">
