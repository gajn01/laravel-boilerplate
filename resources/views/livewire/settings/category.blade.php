                        ...
                        @forelse ($category_list as $category)
                            <tr>
                                ...
                                <td class="cell table-action-sm">
                                    ...
                                    <a href="" wire:click="showModal({{ $category['id'] }})"
                                        data-bs-toggle="modal" data-bs-target="#category_modal">
                                    ...
                                    <a href="#"
                                        wire:click="onAlert(true,'Confirm','Are you sure you want to delete this category record?','Successfully deleted','warning',{{ $category['id'] }})">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6">
            <nav class="app-pagination">
                {{ $category_list->onEachSide(0)->links() }}
            </nav>
            <!--//app-pagination-->
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn app-btn-primary" wire:click="onSave">Save</button>
                </div>
            </div>
        </div>
    </div>
