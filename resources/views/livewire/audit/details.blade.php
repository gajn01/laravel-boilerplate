                ...
                <table class="table app-table-hover mb-0 text-left">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="cell">
                                <span class="badge  {{ $item->audit_form->StatusBadge }}">{{ $item->audit_form->StatusString }}</span>
                            </td>
                            <td class="cell">
                                <a  data-toggle="tooltip" data-placement="top" title="View" href="{{ route('audit.view.result', ['form_id' => $item->form_id, 'summary_id' => $item->id]) }}">
