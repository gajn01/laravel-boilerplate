                ...
                <div class="app-card-body px-4 w-100">
                    ...
                    <div class="item border-bottom py-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-auto">
                                <div class="item-label mb-1"><strong>User ID</strong></div>
                    ...
                    <div class="item border-bottom py-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-auto">
                                ...
                                <div class="item-data">Juan Miguel Garcia</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item border-bottom py-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-auto">
                                ...
                                <div class="item-data">garciajuanmiguel1105@gmail.com</div>
                    ...
                    <div class="item border-bottom py-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-auto">
                                ...
                                <div class="item-data"><span class="badge bg-success">Active</span></div>
                            </div>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="card-header-action col ">
                                <a class="btn-sm app-btn-secondary" href="#" data-bs-toggle="modal" data-bs-target="#assignModal" >Assign Store</a>
